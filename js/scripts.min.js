...
$(function(){$(".section-7 .owl-carousel").owlCarousel({items:1,responsive:{0:{items:1},600:{items:1},1e3:{items:1}},afterAction:function(t){this.$owlItems.removeClass("active"),this.$owlItems.eq(this.currentItem).addClass("active")}}),$(".section-4").waypoint(function(){$(".section-4 .card").each(function(t){var e=$(this);setInterval(function(){e.removeClass("card-off").addClass("card-on")},150*t)})},{offset:"20%"}),$(".section-6").waypoint(function(){$(".section-6 .card").each(function(t){var e=$(this);setInterval(function(){e.removeClass("card-off").addClass("card-on")},150*t)})},{offset:"20%"}),$(".section-5").waypoint(function(){$(".section-5 .treg-item").each(function(t){var e=$(this);setInterval(function(){e.addClass("animated zoomInUp")},150*t)})},{offset:"50%"}),$(".section-7").waypoint(function(){$(".section-7 .slider").each(function(t){var e=$(this);setInterval(function(){e.addClass("animated rollIn")},150*t)})},{offset:"70%"}),$(".s-wrap .s2-items a.s2-item .img-wrap img").equalHeight(),$(".section-4 .cards .card p").equalHeight(),$("#my-menu").mmenu({extensions:["theme-white","fx-menu-fade","pagedim-black"],offCanvas:{position:"left"}}),$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$("body").on("click",".arrow",function(){$("html, body").animate({scrollTop:0},"slow")})}),jQuery("img.svg").each(function(){var t=jQuery(this),e=t.attr("id"),a=t.attr("class"),i=t.attr("src");jQuery.get(i,function(i){var n=jQuery(i).find("svg");void 0!==e&&(n=n.attr("id",e)),void 0!==a&&(n=n.attr("class",a+" replaced-svg")),!(n=n.removeAttr("xmlns:a")).attr("viewBox")&&n.attr("height")&&n.attr("width")&&n.attr("viewBox","0 0 "+n.attr("height")+" "+n.attr("width")),t.replaceWith(n)},"xml")});